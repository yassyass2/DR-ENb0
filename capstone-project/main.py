...
green channel + CLAHE -> median blur -> normalise to [0, 1]), and SMOTE class
balancing is applied to the TRAINING split only. Validation and test keep their
natural class distribution for an honest evaluation.
